...
class MarkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(!$gradingSystem) {
            return back()->withError('Contact admin to create grade system');
        }
        ...
        if(!$gradingSystemRules) {
            return back()->withError('Contact admin to create grade system rules');
        }
    ...
    public function showFinalMark(Request $request)
    {
        ...
        $final_marks_submitted = $markRepository->getFinalMarksCount($current_school_session_id, $semester_id, $class_id, $section_id, $course_id) ?? null;
    ...
    public function showCourseMark(Request $request)
    {
        ...
        if(!$finalMarks) {
            return back()->withError('No final mark is submitted');
        }

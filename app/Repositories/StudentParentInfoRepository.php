...
use App\Repositories\Interfaces\StudentParentInfoRepositoryInterface;
use App\Models\StudentParentInfo;


class StudentParentInfoRepository implements StudentParentInfoRepositoryInterface
{
    public function store($request, $student_id) {
        try {
            return StudentParentInfo::create([
    ...
    public function update($request, $student_id) {
        try {
            return StudentParentInfo::where('student_id', $student_id)->update([
                'father_name'   => $request['father_name'],
                'father_phone'  => $request['father_phone'],
                'mother_name'   => $request['mother_name'],
                'mother_phone'  => $request['mother_phone'],

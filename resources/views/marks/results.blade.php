<x-app-dashboard name="View Results" icon="cloud-sun">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    ...
                    <div class="mb-4 mt-4">
                        <x-form action="{{route('dashboard.course.mark.list.show')}}" method="GET">
                            <div class="row">
                                <div class="col">
                                    <x-form-select name="semester_id" required>
                                        @isset($semesters)
                                ...
                                <div class="col">
                                    <x-form-select onchange="getSectionsAndCourses(this);" name="class_id">
                                        @isset($classes)

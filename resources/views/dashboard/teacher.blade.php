        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 fw-bold text-primary">User Overview</h6>
                </div>
                {{-- {# Card Body #} --}}
                <div class="card-body">
                    <div class="container">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    <img class="img-fluid rounded border-left-info" style="width:16rem;" src="{{ asset('storage/'.$user['profile']->image )}}" alt="{{ $user->profile->first_name }} {{ $user->profile->last_name }}">
                    <p class="my-0 mt-2">
                        I am {{ $user->profile->first_name }} {{ $user->profile->last_name }}
                    </p>
                </div>
            </div>
        </div>

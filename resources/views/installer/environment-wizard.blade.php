...
@section('container')
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('install.environmentSaveWizard') }}" class="tabs-wrap">
            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group {{ $errors->has('admin_first_name') ? ' has-error ' : '' }}">
                    <label for="admin_first_name">
                        {{ trans('installer_messages.environment.wizard.form.admin_first_name_label') }}
                    </label>
                    <input type="text" name="admin_first_name" id="admin_first_name" required placeholder="{{ trans('installer_messages.environment.wizard.form.admin_first_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('admin_last_name') ? ' has-error ' : '' }}">
                    <label for="admin_last_name">
                        {{ trans('installer_messages.environment.wizard.form.admin_last_name_label') }}
                    </label>
                    <input type="text" name="admin_last_name" id="admin_last_name" required placeholder="{{ trans('installer_messages.environment.wizard.form.admin_last_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" required name="admin_email" id="admin_email" required placeholder="{{ trans('installer_messages.environment.wizard.form.admin_email_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('admin_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="admin_password" id="admin_password" required placeholder="{{ trans('installer_messages.environment.wizard.form.admin_password_placeholder') }}" />

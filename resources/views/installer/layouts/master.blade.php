...
<html>
    <head>
        ...
        <link rel="icon"
            type="image/png"
            href="{{ asset('installer/img/favicon/favicon-16x16.png') }}"
            sizes="16x16"/>
        <link rel="icon"
            type="image/png"
            href="{{ asset('installer/img/favicon/favicon-32x32.png') }}"
            sizes="32x32"/>
        <link rel="icon"
            type="image/png"
            href="{{ asset('installer/img/favicon/favicon-96x96.png') }}"
            sizes="96x96"/>
        <link href="{{ asset('installer/css/style.min.css') }}"
            rel="stylesheet"/>
        @yield('style')
        <script>
        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__item {{ isActive('installfinal') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('install.environmentWizard')}} {{ isActive('install.environmentWizard')}} {{ isActive('install.environmentClassic')}}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('install.permissions') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('install.requirements') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('install.welcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
